...
void VertexArray::glBindVertexArray() const {
...
void VertexArray::glVertexArrayVertexBuffer(GLuint bindingindex, GLuint buffer, GLintptr offset, GLsizei stride)
{
...
void VertexArray::glVertexArrayAttribFormat(GLuint attribindex, GLint size, GLenum type, GLboolean normalized, GLuint relativeoffset)
{
    ctx()->VertexArrayAttribFormat(handle(), attribindex, size, type, normalized, relativeoffset);
}

void VertexArray::glVertexAttribPointer(GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const void *pointer)
{
    ctx()->BindVertexArray(handle());
