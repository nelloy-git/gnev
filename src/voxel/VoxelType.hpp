...
public:
    ...
    virtual VoxelRectMesh get_rect_mesh(const VoxelRectInfo& info,
                                        ...
                                        GLenum index_type,
                                        const data::VertexInfo& vertex_info) = 0;

    virtual bool
    is_visible(VoxelSide side, const std::shared_ptr<const VoxelType>& neighbour) const;
    virtual bool
    is_neighbour_side_visible(VoxelSide neighbour_pos, const VoxelType& neighbour) const;
