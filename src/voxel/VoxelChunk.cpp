...
VoxelChunk::VoxelChunk(const std::shared_ptr<GladGLContext> &ctx,
    ...
    : _mesh(ctx, index_type, vertex_info),
      ...
      _top_side_map(VoxelSide::Top, size_x, size_y, size_z),
      _bottom_side_map(VoxelSide::Bottom, size_x, size_y, size_z),
      _front_side_map(VoxelSide::Front, size_x, size_y, size_z),
      _back_side_map(VoxelSide::Back, size_x, size_y, size_z),
      _right_side_map(VoxelSide::Right, size_x, size_y, size_z),
      _left_side_map(VoxelSide::Left, size_x, size_y, size_z)
{
}
...
void VoxelChunk::_insert_side_map(size_type& base_index, VoxelSideMap& side_map)
{
    ...
    for (auto& rect : rectangles){
        ...
        _mesh.vertices().push_back(voxel_mesh.vertices_count * _mesh.vertex_size, voxel_mesh.vertices_data.get());
