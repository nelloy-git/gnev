...
void GlfwConveyor::glfw_key_callback(GLFWwindow *window, int key, int scancode,
                                     int action, int mods) {
  GlfwConveyor *conveyor =
      static_cast<GlfwConveyor *>(glfwGetWindowUserPointer(window));
...
void GlfwConveyor::glfw_cursor_pos_callback(GLFWwindow *window, double pos_x,
                                            double pos_y) {
  GlfwConveyor *conveyor =
      static_cast<GlfwConveyor *>(glfwGetWindowUserPointer(window));
